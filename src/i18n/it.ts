...
export const it: Translation = {
  ...
  serviceDetail: {
    ...
    formTitle: 'Parlaci del tuo progetto',
    formSubtitle: 'Compila questo modulo e il nostro team ti contatterà entro 48 ore.',
    formName: 'Il tuo nome completo',
    formEmail: 'Il tuo indirizzo email',
    formMessage: 'Descrivi brevemente le tue esigenze...',
    formSend: 'Invia la mia richiesta →',
    formSuccess: 'Richiesta inviata!',
    formSuccessMsg: 'Il nostro team ti contatterà entro 48 ore con una proposta personalizzata.',
