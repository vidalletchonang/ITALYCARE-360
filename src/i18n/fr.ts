...
export const fr: Translation = {
  ...
  footer: {
    ...
    copy: '© 2026 ITALYCARE 360 — Tous droits réservés',
  ...
  serviceDetail: {
    ...
    formSubtitle: 'Remplissez ce formulaire et notre équipe vous contactera sous 48h.',
    formName: 'Votre nom complet',
    formEmail: 'Votre adresse e-mail',
    formMessage: 'Décrivez brièvement votre besoin...',
    formSend: 'Envoyer ma demande →',
    formSuccess: 'Demande envoyée !',
    formSuccessMsg: 'Notre équipe vous contactera sous 48 heures avec une proposition personnalisée.',
