...
export const de: Translation = {
  ...
  hero: {
    tag: 'Ihr vertrauenswürdiger Partner in Italien',
    line1: 'Italien,',
    line2: 'vereinfacht',
    line3: 'für Sie.',
    desc: 'Ein einziger Partner für Ihre Lebens- und Investitionsprojekte in Italien — 360°-Expertise, ein dedizierter Ansprechpartner, maßgeschneiderte Betreuung.',
    btn1: 'Projekt starten →',
    btn2: 'Leistungen ansehen ↓',
    scroll: 'Scrollen',
  },
  marquee: ['Immobilien', 'Medizinische Betreuung 360°', 'Renovierung', 'Export Made in Italy', 'Studentenvisum', 'Rechtsberatung', 'Premium-Concierge', 'Verwaltung', 'Eventplanung', 'Seniorenresidenzen', 'Finanzierung', 'Zertifizierte Fachleute'],
  about: {
    label: 'Who we are',
    ...
    items: [
      ...
      },
      {
        ...
        details: {
          ...
          showcase: [
            ...
            { img: "/gallery/american-couple.jpg", title: "Tax Registration & Declarations", desc: "Annual tax declarations and AIRE registration for an American couple owning property in Umbria. Accountant coordination, document submission, and ongoing fiscal compliance." },
          ],
      ...
      },
      {
        ...
        details: {
          ...
          showcase: [
            ...
            { img: '/gallery/corporate-retreat.jpg', title: 'Corporate Retreat in Tuscany', desc: 'A three-day executive retreat at a historic estate in the Chianti hills. Team-building activities, gourmet dining, and strategy sessions in an inspiring Italian setting.' },
      ...
      },
      {
        ...
        details: {
          ...
          showcase: [
            ...
            { img: 'https://images.unsplash.com/photo-1554774853-719586f82d77?auto=format&fit=crop&w=800&q=85', title: 'Bilingual Accountant in Milan', desc: 'An English-Italian accountant found for an expat family managing rental income and tax filings. Ongoing monthly support with quarterly fiscal reviews.' },
      ...
      },
      {
        ...
        details: {
          ...
          showcase: [
            { img: '/gallery/senior-relocation.jpg', title: 'Senior Relocation from London', desc: 'A retired British couple relocated to Lake Garda. Property search, residency permit, healthcare enrollment, local social integration, and ongoing support — a new chapter, worry-free.' },
            { img: '/gallery/home-care.jpg', title: 'Home Care Coordination', desc: 'A live-in caregiver arranged for an elderly parent in Rome. Certified nurse, daily routine, medical liaison, and family video updates — compassionate care at home.' },
      ...
      },
      {
        ...
        details: {
          ...
          showcase: [
            ...
            { img: '/gallery/post-surgery.jpg', title: 'Post-Surgery Rehabilitation', desc: 'A recovery stay in Ischia for a patient after knee surgery. Physiotherapy, thermal pools, medical follow-up, and seaside relaxation — healing in the most beautiful setting.' },
            { img: '/gallery/wellness-retreat.jpg', title: 'Luxury Wellness Retreat', desc: 'A week-long detox and anti-stress programme at a spa in Saturnia, Tuscany. Nutrition plan, massage therapy, yoga sessions, and natural thermal springs — a transformative experience.' },
          ],
      ...
      },
      {
        ...
        details: {
          ...
          showcase: [
            ...
            { img: '/gallery/vip-tour.jpg', title: 'Multi-City European Tour', desc: 'A week-long itinerary: London → Milan → Florence → Rome by private jet, with ground logistics, hotel reservations, and VIP transfers at every stop.' },
            { img: '/gallery/emergency-flight.jpg', title: 'Emergency Medical Flight', desc: 'A last-minute air ambulance arranged within 6 hours for a patient transfer from the Middle East to a specialist clinic in Milan. Life-saving speed, handled with care.' },
          ],
