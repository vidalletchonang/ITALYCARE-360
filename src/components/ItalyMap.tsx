...
const CITIES: City[] = [
  {
    ...
    tagline: { fr: 'La ville royale', en: 'The royal city', it: 'La città reale', ar: 'المدينة الملكية', ru: 'Королевский город' },
    highlights: {
      ...
      ru: ['Финансирование и ипотека', 'Сертифицированные специалисты', 'Ремонт', 'Импорт/Экспорт'],
    },
  },
  {
    id: 'milan', name: 'Milano', cx: 63, cy: 82,
    services: ['immobilier', 'juridique', 'financement', 'aviation-privee'],
    tagline: { fr: 'La capitale financière', en: 'The financial capital', it: 'La capitale finanziaria', ar: 'العاصمة المالية', ru: 'Финансовая столица' },
    highlights: {
      ...
      ru: ['Премиум недвижимость', 'Юридические и налоговые услуги', 'Финансирование и банки', 'Частная авиация'],
    },
  },
  {
    id: 'venice', name: 'Venezia', cx: 120, cy: 83,
    services: ['immobilier', 'conciergerie', 'evenements', 'aviation-privee'],
    tagline: { fr: 'La Sérénissime', en: 'La Serenissima', it: 'La Serenissima', ar: 'مدينة البندقية', ru: 'Ла Серениссима' },
    highlights: {
      ...
      ru: ['Уникальная недвижимость', 'Люкс консьерж', 'Свадьбы и мероприятия', 'Частные трансферы'],
    },
  },
  {
    id: 'bologna', name: 'Bologna', cx: 102, cy: 114,
    services: ['visa-etudiant', 'administratif', 'medical', 'silver-economy'],
    tagline: { fr: 'La ville des savoirs', en: 'The city of knowledge', it: 'La Dotta', ar: 'مدينة العلم', ru: 'Город знаний' },
    highlights: {
      ...
      ru: ['Студенческая виза', 'Административная помощь', 'Медицина 360°', 'Silver Economy'],
    },
  },
  {
    id: 'florence', name: 'Firenze', cx: 101, cy: 138,
    services: ['immobilier', 'renovation', 'conciergerie', 'property-care'],
    tagline: { fr: 'La Renaissance italienne', en: 'Italian Renaissance', it: 'Il Rinascimento italiano', ar: 'النهضة الإيطالية', ru: 'Итальянское Возрождение' },
    highlights: {
      ...
      ru: ['Покупка вилл и дворцов', 'Престижный ремонт', 'Премиум консьерж', 'Управление недвижимостью'],
    },
  },
  {
    id: 'rome', name: 'Roma', cx: 123, cy: 200,
    services: ['administratif', 'juridique', 'visa-etudiant', 'evenements'],
    tagline: { fr: 'La Ville Éternelle', en: 'The Eternal City', it: 'La Città Eterna', ar: 'المدينة الأبدية', ru: 'Вечный город' },
    highlights: {
      ...
      ru: ['Административные услуги', 'Юридическая помощь', 'Виза и проживание', 'Мероприятия 360°'],
    },
  },
  {
    id: 'naples', name: 'Napoli', cx: 155, cy: 235,
    services: ['medical', 'thermal-wellness', 'immobilier', 'conciergerie'],
    tagline: { fr: 'La cité ensoleillée', en: 'The sunny city', it: 'La città solare', ar: 'المدينة المشمسة', ru: 'Солнечный город' },
    highlights: {
      ...
      ru: ['Медицинское наблюдение 360°', 'Термальный велнес', 'Прибрежная недвижимость', 'Неаполитанский образ жизни'],
    },
  },
  {
    id: 'palermo', name: 'Palermo', cx: 139, cy: 328,
    services: ['immobilier', 'conciergerie', 'property-care', 'silver-economy'],
    tagline: { fr: 'La perle de Sicile', en: 'The pearl of Sicily', it: 'Il gioiello della Sicilia', ar: 'جوهرة صقلية', ru: 'Жемчужина Сицилии' },
    highlights: {
      ...
      ru: ['Сицилийская недвижимость', 'Консьерж', 'Управление недвижимостью', 'Silver Economy'],
    },
  },
]

const i18n: Record<string, Record<string, string>> = {
  label:    { fr: 'ITALIE INTERACTIVE',   en: 'INTERACTIVE ITALY',                        it: 'ITALIA INTERATTIVA',                           ar: 'إيطاليا التفاعلية',                      ru: 'ИНТЕРАКТИВНАЯ ИТАЛИЯ' },
  h2a:      { fr: 'Nos experts dans',     en: 'Our experts across',                       it: 'I nostri esperti in',                         ar: 'خبراؤنا في',                              ru: 'Наши эксперты по всей' },
  h2b:      { fr: 'toute l\'Italie',      en: 'all of Italy',                             it: 'tutta Italia',                                ar: 'كل إيطاليا',                              ru: 'Италии' },
  sub:      { fr: 'Cliquez sur une ville pour découvrir nos services locaux.', en: 'Click a city to discover our local services.', it: 'Clicca su una città per scoprire i nostri servizi locali.', ar: 'انقر على مدينة لاكتشاف خدماتنا المحلية.', ru: 'Нажмите на город, чтобы узнать о наших услугах.' },
  services: { fr: 'Services disponibles', en: 'Available services',                       it: 'Servizi disponibili',                         ar: 'الخدمات المتاحة',                         ru: 'Доступные услуги' },
  cta:      { fr: 'Démarrer mon projet →', en: 'Start my project →',                     it: 'Inizia il mio progetto →',                    ar: 'ابدأ مشروعي →',                           ru: 'Начать мой проект →' },
}
