        ...
        {TEAM_MEMBERS.filter(m => !m.pdg).map((m, i) => (
          <div key={i} className="tm-card" onClick={() => setSelected(m)}>
            ...
            <div className="tm-photo">
              {m.photo ? (
                <img src={m.photo} alt={m.name} loading="lazy" style={m.photoPos ? { objectPosition: m.photoPos } : undefined} />
              ) : (
