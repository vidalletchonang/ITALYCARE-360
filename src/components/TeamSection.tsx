...
const TEAM_MEMBERS = [
  { name: 'Fabrizio Permunian', role: { fr:'PDG & Expert Immobilier', en:'CEO & Real Estate Expert', it:'CEO & Esperto Immobiliare', ar:'الرئيس التنفيذي وخبير العقارات', ru:'Генеральный директор и эксперт по недвижимости' }, email: 'fabrizio.p@italianrealestatelawyers.com', photo: `${BASE}/team/fabrizio.svg`, initials: 'FP', color: '#1e3d72', badge: true, pdg: true, bio: 'Fabrizio is a businessman and a dynamic leader who lives in Italy. He is an expert in the Italian real estate market and business success and is a frequent guest speaker on talk shows. He also features in dozens of newspaper and magazine articles about real estate in Italy.' },
