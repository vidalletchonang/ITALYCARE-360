...
const TEAM_MEMBERS = [
  ...
  { name: 'Elena Benetti', role: { fr:'Experte Immobilier & Visa', en:'ITALYCARE 360, Real Estate & Visa Expert', it:'Esperta Immobiliare & Visti', ar:'خبيرة عقارية وتأشيرات' }, email: 'elenabenetti@italianrealestatelawyers.com', photo: `${BASE}/team/elena.png`, initials: 'EB', color: '#0e3d22', badge: true, bio: 'Elena earned her degree in Translation from the University "Scuola Superiore per Mediatori Linguistici" in Padua and a Master\'s from the University of Pescara, specializing in legal, medical, and technical translation. Since 2021, she has assisted clients at Italian Real Estate Lawyers, managing communications and supporting every step of the purchasing process. She speaks Italian, English, and German.' },
  { name: 'Mary Ann Alibin Tomis', role: { fr:'Experte Immobilier & Visa', en:'ITALYCARE 360, Real Estate & Visa Expert', it:'Esperta Immobiliare & Visti', ar:'خبيرة عقارية وتأشيرات' }, email: 'maryann@italianrealestatelawyers.com', photo: `${BASE}/team/maryann.jpg`, initials: 'MA', color: '#1a6b3c', badge: true, bio: "Mary Ann grew up between the Philippines and Italy, embracing multicultural environments with empathy and creativity. She holds a degree in Languages and a Master's in American Languages and Literatures from the University of Naples 'L'Orientale.' With experience in tourism, translation, and communication, she excels in customer relations and problem-solving. She loves art, travel, and exploration." },
  { name: 'Alexandra Munteanu', role: { fr:'Consultante Post-Vente', en:'Post-Sales Consultant', it:'Consulente Post-Vendita', ar:'مستشارة ما بعد البيع' }, email: 'alexandra@italianrealestatelawyers.com', photo: `${BASE}/team/alexandra.png`, initials: 'AM', color: '#c9a84c', badge: false, bio: 'Originally from Teramo, Abruzzo, Alexandra specialized in Language Studies and uses her skills to assist both international and local clients. She manages post-sale and rental services, coordinating with professionals and local authorities. She provides comprehensive support with utilities, taxes, renovations, and insurance. She speaks Italian, English, Romanian, and French.' },
  { name: 'Aurora Campesan', role: { fr:'Consultante Post-Vente', en:'Post-Sales Consultant', it:'Consulente Post-Vendita', ar:'مستشارة ما بعد البيع' }, email: 'aurora@italianrealestatelawyers.com', photo: null, initials: 'AC', color: '#0e3d22', badge: false, bio: 'Aurora is one of the youngest members at Italian Real Estate Lawyers. She specialized in Language Studies and facilitates the process after the sale or rental of a property. She provides a wide range of services concerning utilities, taxes, renovation works, opening bank accounts and insurance. In her free time, Aurora enjoys practicing extreme martial arts. She is fluent in Italian, English, and Spanish.' },
  { name: 'Tyra Bencivenga', role: { fr:'Experte Immobilier & Visa', en:'ITALYCARE 360, Real Estate & Visa Expert', it:'Esperta Immobiliare & Visti', ar:'خبيرة عقارية وتأشيرات' }, email: 'tyra@italianrealestatelawyers.com', photo: `${BASE}/team/tyra.png`, initials: 'TB', color: '#1a6b3c', badge: true, bio: "Tyra holds a degree in Foreign Languages and International Politics from Ca' Foscari University of Venice. She studied in France and Germany, gaining a strong international perspective. Passionate about real estate and negotiation, she has worked in multicultural environments, including the 'United 2018' project with Este Municipality. Tyra is skilled in communication, teamwork, and cross-cultural relations." },
  { name: 'Giorgia Zanardo', role: { fr:'Experte Immobilier & Communication Digitale', en:'ITALYCARE 360, Real Estate & Digital Communication Expert', it:'Esperta Immobiliare & Comunicazione Digitale', ar:'خبيرة عقارية وتواصل رقمي' }, email: 'giorgia@italianrealestatelawyers.com', photo: `${BASE}/team/giorgia.jpg`, initials: 'GZ', color: '#b5261e', badge: true, bio: 'Giorgia holds certifications in English, French, and German and earned her Bachelor Degree in Linguistic Mediation for Business Internationalization from the University of Padua, subsequently specializing in Web Marketing & Digital Business. She assists international clients with real estate transactions and visa procedures and plays an active role in the digital communication strategy. She is fluent in Italian, English, and French.' },
  { name: 'Maryam Ez Zaouia', role: { fr:'Experte Immobilier & Visa', en:'ITALYCARE 360, Real Estate & Visa Expert', it:'Esperta Immobiliare & Visti', ar:'خبيرة عقارية وتأشيرات' }, email: 'maryam@italianrealestatelawyers.com', photo: `${BASE}/team/maryam.jpg`, initials: 'MZ', color: '#0e3d22', badge: true, bio: "Maryam obtained a Bachelor's Degree in English Studies and Linguistics and a Master's Degree in Foreign Applied Languages, specializing in Business, Cultures, and Media. She is certified in Content Creation, Corporate Communication, and Negotiation. Having grown up between multiple cultures, she brings diplomacy and precision to every professional exchange. She is fluent in Italian, English, French, Arabic, and Spanish." },
  { name: 'Annemarie Săvulescu', role: { fr:'Experte Immobilier & Visa', en:'ITALYCARE 360, Real Estate & Visa Expert', it:'Esperta Immobiliare & Visti', ar:'خبيرة عقارية وتأشيرات' }, email: 'annemarie@italianrealestatelawyers.com', photo: `${BASE}/team/annemarie.jpg`, initials: 'AS', color: '#1a6b3c', badge: true, bio: 'Having studied and lived in London for over a decade, Annemarie graduated from Brunel University London with an LLB in Law. At Italian Real Estate Lawyers, she assists aspiring property buyers by guiding them through every stage of the purchasing process. As a proud polyglot, she brings a multicultural perspective and a genuine passion for communication. She is fluent in Italian, English, Spanish, and Romanian.' },
  { name: 'Vidalle Newgep Tchonang', role: { fr:'Ingénieure Web & Consultante SEO', en:'ITALYCARE 360, Web Development & SEO Engineer', it:'Ingegnera Web & Consulente SEO', ar:'مهندسة ويب ومستشارة SEO' }, email: 'vidalle@italianrealestatelawyers.com', photo: null, initials: 'VN', color: '#c9a84c', badge: true, bio: "Holding a Bachelor's degree in Computer Engineering (AI track) from Guglielmo Marconi University in Rome, Vidalle blends cutting-edge technical expertise with a strategic digital vision. Originally from Cameroon, Vidalle moved to Italy in 2017. Her career is defined by a rare versatility, having excelled as a Project Manager and Web Developer. She spearheads technical architecture and SEO optimization at ItalyCare 360." },
  { name: 'Anton Buchkov', role: { fr:'Ingénieur Informatique', en:'Computer Science Engineer & Developer', it:'Ingegnere Informatico', ar:'مهندس حاسوب' }, email: 'anton@italianrealestatelawyers.com', photo: null, initials: 'AB', color: '#0e3d22', badge: false, bio: "Holding a Bachelor's degree in Computer Science from the University of Ferrara (Unife), Anton brings solid technical expertise to the development of digital solutions. Specializing in software architecture and systems optimization, he transforms complex technological challenges into high-performing, user-centric tools for ItalyCare 360." },
]
